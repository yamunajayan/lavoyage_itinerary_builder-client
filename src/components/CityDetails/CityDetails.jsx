    ...
    <section className="city-details">
      ...
      <ul className="city-details__list">
        {cities.map((city, index) => {
          return (
            <li key={city.cityName} className="city-details__item">
              <div className="city-details__image-box">
                <CountryCard
                  countryName={city.cityName}
                  countryImage={city.cityImage}
                />
              </div>
              <article className="city-details__details">
                <p className="city-details__info">{city.cityDescription}</p>
                <p className="city-details__info city-details__info--days">
                  Days to spend : {city.recommendedStayDuration}
                </p>
